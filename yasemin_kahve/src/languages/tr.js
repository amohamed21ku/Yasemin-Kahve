...
"enrolledMessage":"Bu kursa başarıyla kaydoldunuz. Detaylar için sizinle iletişime geçeceğiz",
  ...
  "errorRemovingImage": "Resim kaldırılırken hata oluştu. Lütfen tekrar deneyin.",
  "fileTooLarge": "Dosya boyutu 5MB'dan küçük olmalıdır",
  "invalidFileType": "Lütfen geçerli bir resim dosyası seçin",
  "uploadPermissionError": "Dosya yükleme izniniz yok. Lütfen kimlik doğrulamanızı kontrol edin.",
  ...
  "courseLevel": "Kurs Seviyesi",
  "maxStudents": "Maksimum Öğrenci",
  "endDate": "Bitiş Tarihi",
  "originalPrice": "Orijinal Fiyat (TL)",
  "locationEn": "Konum (İngilizce)",
  "locationTr": "Konum (Türkçe)",
  "instructorSelection": "Eğitmen Seçimi",
  "selectInstructor": "Eğitmen Seç",
  "chooseInstructor": "Bir eğitmen seçin...",
  "createNewInstructor": "Yeni Eğitmen Oluştur",
  "titleRequired": "Kurs başlığı her iki dilde de gereklidir",
  "priceAndCapacityRequired": "Fiyat ve maksimum öğrenci sayısı gereklidir",
  "instructorRequired": "Lütfen bir eğitmen seçin",
  "instructorDetailsRequired": "Lütfen tüm eğitmen detaylarını doldurun",
  "instructorCreatedNote": "Eğitmen, kursu kaydettiğinizde oluşturulacaktır.",
